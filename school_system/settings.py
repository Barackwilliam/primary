...
SECRET_KEY = 'django-insecure-2y8ul9*qpgo=1iu8q^xt@-1gqf2w^y-(_73n(ab7zi1z$h=2pw'
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # kwa render
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',       
        'USER': 'postgres.mtvxpvfhjyhdxbuivpxj',           
        'PASSWORD': 'NyumbaChap',    
...
# Twilio settings for SMS (You need to sign up for Twilio and replace these)
